    ...
    <div>
      ...
      <center>
        <div className="searchBox">
          <input className="searchInput" type="text" placeholder="Search something"></input>
      ...
      <section className="listings">
        ...
        <div id="listing-container" className="listing-container"></div>
      </section>

      <footer>
        <p>&copy; 2023 Airbnb Clone. Todos los derechos reservados.</p>
      </footer>
    </div>
  );
}